...
<script language="javascript">
	function pageForword(){
		...
		if('undefined'!=temp&&temp!=""&&temp!=null){
			ex = temp;
			if(ex == 'xls'){
				actionName = "importplantrackfiles.action?ex=xls";
				
			}else if(ex == 'xlsx'){
				actionName = "importplantrackfiles.action?ex=xlsx";
			}else{
...
<div class="box1" panelWidth="400">
	...
	<tr><b></>Excel 格式如下 : </b></tr>
		<tr bgcolor='#F4FAFF'><td>序号</td><td>购物车号</td><td>行号</td><td>采购方案号</td><td>采购方案包号</td></tr>
		<tr bgcolor='#F4FAFF'><td>1</td><td>1000002301</td><td>2</td><td>CG2012-02-001</td><td>AH2012-02-001</td></tr>
		<tr bgcolor='#F4FAFF'><td>2</td><td>1000002301</td><td>3</td><td>CG2012-02-001</td><td>AH2012-02-001</td></tr>
		<tr bgcolor='#F4FAFF'><td>3</td><td>1000002301</td><td>4</td><td>CG2012-02-001</td><td>AH2012-02-001</td></tr>
	</table>
	</div>
</form>
</body>
