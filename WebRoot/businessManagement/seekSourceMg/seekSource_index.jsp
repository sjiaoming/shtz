...
<script type="text/javascript">
	...
	function openWin8(){
		...
		diag.URL = "businessManagement/seekSourceMg/import_input.jsp";
		diag.Height=480;
		diag.Width=430;
	...
	function cancelPlans(){
				...
				this.form1.action = "cancelPlans_seekSource.action?tags="+tags;
				this.form1.submit();
				return;
		}
</script>
	...
	<input type="hidden" name="resetflag" id="resetflag" value="${resetflag }" />
		<table>
			<tr>
				...
				<td>合同执行方式：</td>
				<td>
					<select  name="contractExecutionWay" id="contractExecutionWay" >
					    <option value="0" <c:if test="${contractExecutionWay == '1' ||  contractExecutionWay == '2'}">selected="selected"</c:if> >统谈统签和其他</option>
				...
				<td><input type="button" value="导入" onclick='openWin8()'/></td>
				</c:if>
