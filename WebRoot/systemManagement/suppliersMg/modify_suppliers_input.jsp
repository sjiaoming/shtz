...
function ok(){
		...
		this.form1.action = "update_suppliers.action";
		this.form1.submit();
		//top.Dialog.close();
		return;
	}
...
<input type="hidden" name="suppliersId" value="${su.id}">
<div class="box1" panelWidth="500">
	<table class="tableStyle" formMode="true">
		<tr>
			<th colspan="2">修改使用单位信息</th>
		</tr>
		<tr>
			<td>单位名称：</td><td><input type="text"  name="suppliersName" value="${su.name }"/></td>
		</tr>
		<tr>
			<td>单位备注：</td><td><input type="text"  name="suppliersRemark"  value="${su.remark}"/></td>
		</tr>
