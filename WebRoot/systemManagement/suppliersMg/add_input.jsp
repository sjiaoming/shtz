...
function ok(){
//alert('00');
		this.form1.action = "add_suppliers.action";
		this.form1.submit();
		//top.Dialog.close();
		return;
	}
...
<div class="box1" panelWidth="500">
	<table class="tableStyle" formMode="true">
		<tr>
			<th colspan="2">添加供应商信息</th>
		</tr>
		<tr>
			<td>供应商名称 ：</td><td><input type="text"  name="suppliersName" /></td>
		</tr>
		<tr>
			<td>供应商描述：</td><td><input type="text"  name="suppliersRemark"/></td>
		</tr>
		<tr>
			<td colspan="2">
