...
function ok(){
		...
		this.form1.action = "update_usecomp.action";
		this.form1.submit();
		//top.Dialog.close();
		return;
	}
...
<input type="hidden" name="useCompId" value="${uc.id}">
<div class="box1" panelWidth="500">
	<table class="tableStyle" formMode="true">
		...
		<tr>
			<td>单位名称：</td><td><input type="text"  name="userCompName" value="${uc.name }"/></td>
		</tr>
		<tr>
			<td>单位备注：</td><td><input type="text"  name="userCompRemark"  value="${uc.remark}"/></td>
		</tr>
