...
function ok(){
		...
		this.form1.action = "add_organization.action";
		this.form1.submit();
		top.Dialog.close();
		return;
	}
...
<body>
<form action="#" id="form1" name="form1"  target="frmright">
<input type="hidden" name="parentId" value="<%=Integer.parseInt(request.getParameter("organizationId"))%>">
<div class="box1" panelWidth="500">
	<table class="tableStyle" formMode="true">
		<tr>
			<th colspan="2">添加部门信息</th>
		</tr>
		<tr>
			<td>上级部门：</td><td><input type="text"  name="parentName" readonly="readonly"  value="<%=request.getParameter("organizatioName").toString()%>"/></td>
		</tr>
		<tr>
			<td>部门名称：</td><td><input type="text"  name="newname"/></td>
		</tr>
		<tr>
			<td>部门描述：</td><td><input type="text"  name="description"/></td>
		</tr>
